...
@main.route("/add_birthday", methods=["GET", "POST"])
@login_required
@password_set
@email_confirmed
def add_birthday():
...
@main.route("/delete_birthday/<int:id>", methods=["GET", "POST"])
@login_required
@password_set
@email_confirmed
...
@main.route("/edit_birthday/<int:id>", methods=["GET", "POST"])
@login_required
@password_set
@email_confirmed
...
@main.route("/update_profile/<int:id>", methods=["GET", "POST"])
@login_required
@password_set
@email_confirmed
